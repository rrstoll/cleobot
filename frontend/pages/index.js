...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="bg-bg-colorPapyrus border-4 border-yellow-700 md:min-w-[600px] lg:min-w-[768px] max-w-3xl w-full rounded-xl shadow-2xl mx-4 p-8 backdrop-blur">
