  ...
  return (
    <>
      ...
      <div className="border-4 bg-colorLtGreen border-white md:min-w-[600px] lg:min-w-[768px] max-w-3xl w-full shadow-2xl mx-2 p-8 backdrop-blur">
        <div className="mb-6">
          <h1 className="text-4xl text-center tracking-wide font-playfair font-bold text-colorDkGreen mb-4">History<span className=" text-colorGreen font-normal">Speaks</span></h1>
          <h2 className="text-md text-center italic text-white mb-4">Converse with minds that shaped the world.</h2>
        </div>
        ...
        <div className="flex justify-center">
          <button
            className="bg-colorDkGreen text-white tracking-wide font-bold px-10 py-3 rounded-sm hover:bg-colorGreen transition"
            onClick={sendMessage}
          >
            Send
          </button>
